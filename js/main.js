...
mapFiltres.setAttribute('disabled');

var mapPin = document.querySelector('.map__pin--main');

mapPin.addEventListener('mousedoun', function () {
  allfieldsets.removeAttribute('disabled');

  document.addEventListener('keydoun', function (evt) {
    evt.preventDefault();
    if (evt.key === 'Escape') {
      allfieldsets.classList.add('disabled');
    }
});
});
